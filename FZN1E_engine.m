function [Engine] = FZN1E_engine()
% ========================================================================
% This is effectively a carbon copy of Mr Mokotoff and Mr Arnson's LEAP
% 1A26 that is included with FAST however thrust has had to be tweeked
% slightly so that errors aren't produced by the programme. One such error
% is shown below.
...
% Had to vastly increase thrust to not get the below warning. 
% Warning: Excess Power (Ps) < 0 for some segments in cruise.
% Design point thrust [N]
Engine.DesignThrust = 170000;
